package me.passtheheadphones.updater;
...
public class UpdateService extends IntentService {
	 ...
	 */
	private static final String RELEASES_PAGE = "https://api.github.com/repos/stuxo/PTHAndroid/releases";

	public UpdateService(){
		super("PTHAndroid-UpdateService");
	}
	...
	private void notifyNewRelease(GitRelease release){
		...
		builder.setSmallIcon(R.drawable.ic_launcher)
			.setContentTitle("PTH Update Available")
